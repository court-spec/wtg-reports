...
def _zip_to_market(z):
    ...
    if p2 == '77':        return 'HOU'
    if p2 == '78':
        # 78001-78299 = San Antonio metro, 78600+ = Austin metro (approx)
        try:
            n = int(s[2:])
            return 'SA' if n < 600 else 'AUS'
        except: return None
    if p2 == '85':        return 'PHX'
    if p2 == '86' and s.startswith('857'): return 'PHX'  # Tucson area
